# This file is modified from https://github.com/huggingface/trl/blob/main/examples/research_projects/stack_llama_2/scripts/sft_llama2.py

# Fine-Tune Llama2-7b on PKU-Beaver dataset
import os
...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(default="PKU-Alignment/PKU-SafeRLHF", metadata={"help": "the dataset name"})
    train_split: Optional[str] = field(default="train", metadata={"help": "the train split to use"})
    test_split: Optional[str] = field(default="test", metadata={"help": "the train split to use"})
    ...
    max_steps: Optional[int] = field(default=7000, metadata={"help": "the maximum number of sgd steps"})
    ...
    output_dir: Optional[str] = field(default="./results_sft_llama2", metadata={"help": "the output directory"})
